...
var ApacheUsernamePasswordCredentials = org.apache.http.auth.UsernamePasswordCredentials
...
var request = function(client, params)
{
    ...
    response.charSet = response.charSet === null ? 'UTF-8' : String(response.charSet);
